...
const { config, css, getCssText, keyframes, styled, theme, globalCss } = createStitches({
  theme: {
    colors: {
      ...
      // light
      'honghong-colors-brand': 'hsla($palette-blue-50, 100%)',
      'honghong-colors-emphasis': 'hsla($palette-blue-50, 5%)',
      'honghong-colors-white-in-white': 'hsla($palette-gray-00, 100%)',
      'honghong-colors-body': 'hsla($palette-gray-05, 25%)',
      'honghong-colors-body-secondary': 'hsla($palette-gray-05, 100%)',
      'honghong-colors-header': 'hsla($palette-gray-02, 40%)',
...
export const darkTheme = createTheme({
  colors: {
    // dark
    'honghong-colors-brand': 'hsla($palette-blue-45, 100%)',
    'honghong-colors-emphasis': 'hsla($palette-blue-35, 10%)',
